...
If "s3AuthMethod" : "IAM_ROLE", then you don't need to include awsSecretKey."""
        ...
        custom_certificates: Optional[list[CustomcertificatesParams]] = Field(serialization_alias="customCertificates")
...
To learn about write acknowledgement levels in MongoDB, see Write Concern."""
    ...
    class DeletePathParams(BaseModel):
        model_config = ConfigDict(populate_by_name=True)
        s3_oplog_config_id: str = Field("None", serialization_alias="S3-OPLOG-CONFIG-ID")
